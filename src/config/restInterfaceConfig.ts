...
export let loginUser = "/login";
export let getAllMessages = "/getAllMsg";
export let getAllBroadcastMessages = "/getAllBroadcastMessages";
export let getAllMessagesFromContact = "/getAllMessagesFromContact";
